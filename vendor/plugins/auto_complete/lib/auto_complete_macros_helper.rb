module AutoCompleteMacrosHelper      
  ...
  def auto_complete_result(entries, field, phrase = nil)
    ...
    items = items.map { |item| item.html_safe}
    @items_string = "".html_safe
    items.uniq.each {|item| @items_string += item.html_safe}
    content_tag("ul", @items_string)
  end
  ...
  def text_field_with_auto_complete(object, method, tag_options = {}, completion_options = {})
    ...
    text_field(object, method, tag_options).html_safe +
